...
class UserController extends Controller
{
        ...
        public function listGoogleUser(Request $request){
          ...
          return view('influencer.activation-view',compact('users'))->with('i', ($request->input('page', 1) - 1) * 5);;
         //return view('influencer.activation-view')->with('logged_user',compact('users'));
        }
}